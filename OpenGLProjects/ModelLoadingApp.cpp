...
bool ModelLoadingApp::Init()
{
	...
	//m_pMesh = new OglDev::Mesh();
	//return m_pMesh->LoadMesh("../Content/phoenix_ugv.md2");

	return 1;
}

void ModelLoadingApp::Run() {
	...
	Shader shader("BasicMesh.vs", "BasicMesh.frag");
	LearnOpenGL::Model objmodel("../Content/Nanosuit/nanosuit.obj");
...
void ModelLoadingApp::CreateBuffers() {
...
void ModelLoadingApp::CreateTextures() {
